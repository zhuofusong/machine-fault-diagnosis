...
parser.add_argument("--pythonLibrary", help="which python library to use (pyfmi or fmpy)", type=str, default='pyfmi')
parser.add_argument("--simulationEndTime", help="simulation ending time", type=float)
parser.add_argument("--modelFile",help="FMU model file path", type=str)
