 ...
 * returns Object
 **/
exports.modelFlowNodeModelFlowIdNodeIdComponentDELETE = function(modelFlowId,nodeId) {
 ...
 * returns List
 **/
exports.modelFlowNodeModelFlowIdNodeIdComponentGET = function(modelFlowId,nodeId) {
  return new Promise(function(resolve, reject) {
    var examples = {};
    examples['application/json'] = [ {
 ...
 * returns List
 **/
exports.modelFlowNodeModelFlowIdNodeIdComponentPOST = function(modelFlowId,nodeId) {
  return new Promise(function(resolve, reject) {
    var examples = {};
    examples['application/json'] = [ {
  "modifiedTime" : 6.027456183070403,
 ...
 * returns List
 **/
exports.modelFlowNodeModelFlowIdNodeIdComponentPUT = function(modelFlowId,nodeId) {
  return new Promise(function(resolve, reject) {
    var examples = {};
    examples['application/json'] = [ {
  "modifiedTime" : 6.027456183070403,
